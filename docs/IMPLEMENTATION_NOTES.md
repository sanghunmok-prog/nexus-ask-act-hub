...
This file locks the current repository-level implementation conventions that reflect merged work through PR-04.
...
## Current merged implementation through PR-04
...
Current frontend consumption pattern is fetch + ReadableStream
